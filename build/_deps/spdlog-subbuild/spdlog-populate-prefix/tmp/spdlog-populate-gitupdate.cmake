...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.x"
  WORKING_DIRECTORY "/home/why/Desktop/webserver_main/lib/spdlog"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/why/Desktop/webserver_main/lib/spdlog'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/why/Desktop/webserver_main/lib/spdlog'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
